...
const PLAYERS = 3; 
const NO_OF_STARTING_CARDS = 2;


let playerOnePoints = STARTING_POKER_CHIPSs ;
let playerTwoPoints = STARTING_POKER_CHIPSs ;
let playerThreePoints = STARTING_POKER_CHIPSs ;
